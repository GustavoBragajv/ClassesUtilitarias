...
public class DateAndTimeFormatter {
    ...
    public static void main(String[] args) {
        ...
        DateTimeFormatter usDateAndTimeFormatter = DateTimeFormatter.ofPattern("EEEE MMM dd yyyy", usLocale);
        
        DateTimeFormatter myDateTimeFormatter = DateTimeFormatter.ofLocalizedDate(FormatStyle.LONG).localizedBy(lkLocale);
        ...
        String localizedDateForUS = today.format(usDateAndTimeFormatter);
